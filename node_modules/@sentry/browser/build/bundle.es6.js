...
var Sentry = (function (exports) {
  ...
  ***************************************************************************** */
   ...
   */
  const extractSafariExtensionDetails = (func, url) => {
  ...
  function injectReportDialog(options = {}) {
      ...
      const script = global$4.document.createElement('script');
      script.async = true;
      ...
      const injectionPoint = global$4.document.head || global$4.document.body;
      if (injectionPoint) {
      ...
      setupOnce() {
          addGlobalEventProcessor((event) => {
              ...
              if (getCurrentHub().getIntegration(UserAgent)) {
                  ...
                  const url = ((_a = event.request) === null || _a === void 0 ? void 0 : _a.url) || ((_b = global$5.location) === null || _b === void 0 ? void 0 : _b.href);
                  const { referrer } = global$5.document || {};
                  const { userAgent } = global$5.navigator || {};
